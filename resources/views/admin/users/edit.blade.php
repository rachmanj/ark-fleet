        ...
        <div class="card-body">
          ...
          <div class="row">
            <div class="col-md-8">
              <div class="form-group">
                <label>Project</label>
                <select name="project_id" class="form-control select2bs4" style="width: 100%;">
                  @foreach ($projects as $project)
                    <option value="{{ $project->id }}" {{ old('project_id') == $project->id || $project->id == $user->project_id ? 'selected' : '' }}>{{ $project->project_code }}</option>
                  @endforeach
                </select>
              </div>
            </div>
